...
public class ConnectionManager {
	...
	private int writeData(SocketChannel sChannel, String jsonString){
		...
		try {
            ...
            Log.d("ERROR","ISIDE WRITE DATA Byte ength "+buf.length);
            Log.d("ERROR","INSIDE WRITE BYTEYFFER "+bytebuf.limit());
		    Log.d("ERROR", "writeData: start:limit = " + bytebuf.position() + " : " + bytebuf.limit());
	...
	public int pushOutData(String jsonString){
        Log.d("ERROR","CONNN MAN"+jsonString.length());
