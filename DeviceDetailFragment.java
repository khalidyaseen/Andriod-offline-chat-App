...
public class DeviceDetailFragment extends Fragment {
    ...
    public static DeviceDetailFragment frag;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        frag=(DeviceDetailFragment)getFragmentManager().findFragmentById(R.id.frag_detail);
             ...
             /*   progressDialog = ProgressDialog.show(getActivity(), "Press back to cancel",
                        ...
                        new DialogInterface.OnCancelListener() {
                            ...
                            public void onCancel(DialogInterface dialog) {
                                ...
                                ( (DeviceActionListener) DeviceListFragment.con).cancelDisconnect();
                            }
                        });
                        */
                // perform p2p connect upon user click the connect button, connect available handle when connection done.
                //WiFiDirectActivity dr=new WiFiDirectActivity();


                ((details) getActivity()).connect(config);
        ...
        mContentView.findViewById(R.id.btn_disconnect).setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        ((details)getActivity()).disconnect();
                    }
                });
        ...
        mContentView.findViewById(R.id.btn_start_client).setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        ((details)getActivity()).startChatActivity(null);  // no init msg if started from button click.
                    }
                });
