 ...
 */
public class WiFiDirectActivity extends ActivityExtender implements DeviceActionListener {
    ...
    public void onConnectionInfoAvailable(final WifiP2pInfo info) {
        runOnUiThread(new Runnable() {
            @Override public void run() {
             //   DeviceDetailFragment dd=(DeviceDetailFragment) getFragmentManager().findFragmentById(R.id.frag_detail);
              //  dd.onConnectionInfoAvailable(info);

                //details d = new details();
                //d.onConnectionInfoAvailable(info);
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.about:
            	...
            	Toast.makeText(this, "Kashmir goes Peer-Peer.......", Toast.LENGTH_LONG).show();
            	return true;
            	
            case R.id.help:
            	PTPLog.d(TAG, "onOptionsItemSelected : help ");
            	Toast.makeText(this, "Use Peer-Peer to fight  censorship", Toast.LENGTH_LONG).show();
            	return true;
    ...
    public void showDetails(WifiP2pDevice device) {
        ...
        Intent n= new Intent(getBaseContext(),details.class);
        startActivity(n);
